...
# (pl_elisa <- ggarrange(plot_il6, plot_il6_log, plot_ifng, plot_ifng_log, 
#                         labels = c("A", "B", "C", "D"),
#                         nrow = 2, ncol = 2, common.legend = TRUE,
#                      legend = "bottom")
#     )
# save_function_elisa(pl_elisa, "elisa_plots", a = 7, b = 6)

# pl_elisaln <- ggarrange(plot_il6_log, plot_ifng_log,
#                         labels = c("A", "B"), ncol = 2, common.legend = TRUE, legend = "bottom")
# save_function_elisa(pl_elisaln, "elisa_plots_ln", a = 7, b = 3.5)
